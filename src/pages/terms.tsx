...
import { TERMS_PAGE_DESC, TERMS_PAGE_TITLE, SITE_META } from '@/utils/constants'
...
export default function Terms() {
  return (
    <>
      <Meta pageTitle={TERMS_PAGE_TITLE} pageDesc={TERMS_PAGE_DESC} />
      <div className="document-styles">
        <h1>{TERMS_PAGE_TITLE}</h1>
        <p>
          この利用規約（以下、「本規約」といいます。）は、このウェブサイト上で提供するサービス「
          {siteTitle}
